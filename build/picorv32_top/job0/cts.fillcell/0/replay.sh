...
CD_WORK="/nfs/sc_compute/builds/0dc368a6940a4df4bc65e8967a8d3eeb/picorv32_top/job0/cts.fillcell/0"
PRINT=""
CMDPREFIX=""
SKIPEXPORT=0
while [[ $# -gt 0 ]]; do
...
case $PRINT in
    ...
    "directory")
        ...
        ;;
    "command")
        echo "openroad -no_init -metrics reports/metrics.json -exit /venv/lib/python3.10/site-packages/siliconcompiler/tools/openroad/scripts/apr/sc_fillercell_insertion.tcl"
        exit 0
        ;;
esac
...
openroad \
  ...
  -exit \
  /venv/lib/python3.10/site-packages/siliconcompiler/tools/openroad/scripts/apr/sc_fillercell_insertion.tcl
