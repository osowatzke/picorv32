...
CD_WORK="/nfs/sc_compute/builds/0dc368a6940a4df4bc65e8967a8d3eeb/picorv32_top/job0/syn/0"
PRINT=""
CMDPREFIX=""
SKIPEXPORT=0
while [[ $# -gt 0 ]]; do
...
case $PRINT in
    ...
    "directory")
        ...
        ;;
    "command")
        echo "yosys -c /venv/lib/python3.10/site-packages/siliconcompiler/tools/yosys/sc_synth_asic.tcl"
        exit 0
        ;;
esac
...
yosys \
  -c \
  /venv/lib/python3.10/site-packages/siliconcompiler/tools/yosys/sc_synth_asic.tcl
